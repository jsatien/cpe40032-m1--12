...
function love.load()
    ...
    bd = love.graphics.newImage('image/art.png')
    ...
    player1 = Paddle(9.5, 30, 5, 25)
    player2 = Paddle(VIRTUAL_WIDTH - 15, VIRTUAL_HEIGHT - 30, 5, 25)
    ball = Ball(VIRTUAL_WIDTH / 2 - 2, VIRTUAL_HEIGHT / 2 - 3, 5, 5)
...
function love.draw()
    ...
    if gameState == 'start' then
        love.graphics.setFont(smallFont)
        love.graphics.printf('Welcome to Pong!', 100, 10, VIRTUAL_WIDTH, 'left')
        love.graphics.printf('Press Spacebar to begin!', -90, 10, VIRTUAL_WIDTH, 'right')
    elseif gameState == 'serve' then
        love.graphics.setFont(smallFont)
        love.graphics.printf('Prepare yourselves!',
            100, 10, VIRTUAL_WIDTH, 'left')
        love.graphics.printf('Press Spacebar to start',-90, 10, VIRTUAL_WIDTH, 'right')
    elseif gameState == 'play' then
